...
public class UserServiceUnitTest {
    ...
    public void whenUserIdIsProvided_thenRetrievedNameIsCorrect() {
        Mockito.when(nameService.getUserName("UserId")).thenReturn("Test user name");
        String testName = userService.getUserName("UserId");
        Assert.assertEquals("Test user name", testName);
    }
}